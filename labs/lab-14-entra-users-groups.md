...
- [ ] **Task 1:** Create a **security group** named `SG-Developers` in Microsoft Entra ID with description "Development team members"
- [ ] **Task 2:** Create a new **user** named `dev-user-01` with display name `Dev User 01` (any temporary password)
- [ ] **Task 3:** Add `dev-user-01` as a **member** of the `SG-Developers` group
